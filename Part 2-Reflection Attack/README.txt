...
The communication messages appear on screen. Alice first gets authenticated. Trudy then uses reflection attack and is authenticated to be Alice, thus successfully impersonating Alice.